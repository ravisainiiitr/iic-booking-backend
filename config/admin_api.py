...
def admin_api_router():
    ...
    class EquipmentViewSet(ModelViewSet):
        ...
        def bulk_reserve_external(self, request, pk=None):
            """
            Deprecated: Reserved for External was replaced by External Slot Quota (%).
            Kept so existing clients get HTTP 410 instead of a surprising 404.
            """
            return Response(
                {
                    "error": (
                        "Reserved for External was replaced by External Slot Quota (%). "
                        "Use the External Slot Quota settings instead of bulk-reserve-external."
                    ),
                },
