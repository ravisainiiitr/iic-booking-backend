...
from iic_booking.users.api.wallet_recharge_parse_views import (
...
from iic_booking.users.api.portal_legacy_bridge_views import (
    ...
    portal_legacy_booking_blocks,
    portal_legacy_booking_detail,
    portal_legacy_bookings,
    portal_legacy_conflict_analysis,
    portal_legacy_equipment_capacity_split_detail,
    portal_legacy_equipment_capacity_split_preview,
    portal_legacy_equipment_capacity_splits,
    portal_legacy_equipment_mapping_detail,
    portal_legacy_equipment_mapping_export,
    portal_legacy_equipment_mapping_validate,
    portal_legacy_equipment_mappings,
    portal_legacy_migration_dry_run,
    portal_legacy_migration_overview,
    portal_legacy_portal_action_gate,
    portal_legacy_upcoming_discovery,
    portal_datetime_contract,
    portal_equipment_mapping_import_preview,
    portal_migration_email_preview,
    portal_migration_notification_dry_run,
    portal_migration_summary_dashboard,
    portal_phase10g_go_no_go,
    portal_phase10i_go_no_go,
    portal_phase10j_go_no_go,
    portal_phase10k_go_no_go,
    portal_phase10l_go_no_go,
    portal_phase10m_go_no_go,
    portal_test_account_dry_run,
)
...
from iic_booking.equipment.api_views import (
    ...
    booking_result_attachment_download,
...
urlpatterns = router.urls + [
    ...
    path("v1/portal-migration/admin/equipment-mappings/capacity-splits/", portal_legacy_equipment_capacity_splits, name="portal-legacy-equipment-capacity-splits-v1"),
    path("v1/portal-migration/admin/equipment-mappings/capacity-splits/<int:split_id>/", portal_legacy_equipment_capacity_split_detail, name="portal-legacy-equipment-capacity-split-detail-v1"),
    path("v1/portal-migration/admin/equipment-mappings/capacity-splits/<int:split_id>/preview/", portal_legacy_equipment_capacity_split_preview, name="portal-legacy-equipment-capacity-split-preview-v1"),
    path("v1/portal-migration/admin/equipment-mappings/<int:mapping_id>/", portal_legacy_equipment_mapping_detail, name="portal-legacy-equipment-mapping-detail-v1"),
    path("v1/portal-migration/admin/datetime-contract/", portal_datetime_contract, name="portal-datetime-contract-v1"),
    path("v1/portal-migration/admin/conflict-analysis/", portal_legacy_conflict_analysis, name="portal-legacy-conflict-analysis-v1"),
    path("v1/portal-migration/admin/equipment-mappings/import-preview/", portal_equipment_mapping_import_preview, name="portal-equipment-mapping-import-v1"),
    path("v1/portal-migration/admin/test-account-dry-run/", portal_test_account_dry_run, name="portal-test-account-dry-run-v1"),
    path("v1/portal-migration/admin/phase10g-go-no-go/", portal_phase10g_go_no_go, name="portal-phase10g-go-no-go-v1"),
    path("v1/portal-migration/admin/phase10i-go-no-go/", portal_phase10i_go_no_go, name="portal-phase10i-go-no-go-v1"),
    path("v1/portal-migration/admin/phase10j-go-no-go/", portal_phase10j_go_no_go, name="portal-phase10j-go-no-go-v1"),
    path("v1/portal-migration/admin/phase10k-go-no-go/", portal_phase10k_go_no_go, name="portal-phase10k-go-no-go-v1"),
    path("v1/portal-migration/admin/phase10l-go-no-go/", portal_phase10l_go_no_go, name="portal-phase10l-go-no-go-v1"),
    path("v1/portal-migration/admin/phase10m-go-no-go/", portal_phase10m_go_no_go, name="portal-phase10m-go-no-go-v1"),
    path("v1/portal-migration/admin/upcoming-discovery/", portal_legacy_upcoming_discovery, name="portal-upcoming-discovery-v1"),
    path("v1/portal-migration/admin/legacy-bookings/", portal_legacy_bookings, name="portal-legacy-bookings-v1"),
    path("v1/portal-migration/admin/legacy-bookings/<int:legacy_booking_id>/", portal_legacy_booking_detail, name="portal-legacy-booking-detail-v1"),
    path("v1/portal-migration/admin/migration-summary/", portal_migration_summary_dashboard, name="portal-migration-summary-v1"),
    path("v1/portal-migration/admin/legacy-blocks/", portal_legacy_booking_blocks, name="portal-legacy-booking-blocks-v1"),
    path("v1/portal-migration/admin/legacy-overview/", portal_legacy_migration_overview, name="portal-legacy-migration-overview-v1"),
    path("v1/portal-migration/admin/legacy-dry-run/", portal_legacy_migration_dry_run, name="portal-legacy-migration-dry-run-v1"),
    path("v1/portal-migration/admin/batches/<int:batch_id>/abort/", portal_legacy_batch_abort, name="portal-legacy-batch-abort-v1"),
    ...
    path(
        "department-faculty-credit-facility/my-status/",
        department_faculty_credit_facility_my_status_view,
        name="department-faculty-credit-facility-my-status",
    ),
    path(
        "department-faculty-credit-facility/avail/",
        department_faculty_credit_facility_avail_view,
        name="department-faculty-credit-facility-avail",
    ),
    ...
    path("portal-migration/admin/equipment-mappings/capacity-splits/", portal_legacy_equipment_capacity_splits, name="portal-legacy-equipment-capacity-splits"),
    path("portal-migration/admin/equipment-mappings/capacity-splits/<int:split_id>/", portal_legacy_equipment_capacity_split_detail, name="portal-legacy-equipment-capacity-split-detail"),
    path("portal-migration/admin/equipment-mappings/capacity-splits/<int:split_id>/preview/", portal_legacy_equipment_capacity_split_preview, name="portal-legacy-equipment-capacity-split-preview"),
    path("portal-migration/admin/equipment-mappings/<int:mapping_id>/", portal_legacy_equipment_mapping_detail, name="portal-legacy-equipment-mapping-detail"),
    path("portal-migration/admin/datetime-contract/", portal_datetime_contract, name="portal-datetime-contract"),
    path("portal-migration/admin/conflict-analysis/", portal_legacy_conflict_analysis, name="portal-legacy-conflict-analysis"),
    path("portal-migration/admin/equipment-mappings/import-preview/", portal_equipment_mapping_import_preview, name="portal-equipment-mapping-import"),
    path("portal-migration/admin/test-account-dry-run/", portal_test_account_dry_run, name="portal-test-account-dry-run"),
    path("portal-migration/admin/phase10g-go-no-go/", portal_phase10g_go_no_go, name="portal-phase10g-go-no-go"),
    path("portal-migration/admin/phase10i-go-no-go/", portal_phase10i_go_no_go, name="portal-phase10i-go-no-go"),
    path("portal-migration/admin/phase10j-go-no-go/", portal_phase10j_go_no_go, name="portal-phase10j-go-no-go"),
    path("portal-migration/admin/phase10k-go-no-go/", portal_phase10k_go_no_go, name="portal-phase10k-go-no-go"),
    path("portal-migration/admin/phase10l-go-no-go/", portal_phase10l_go_no_go, name="portal-phase10l-go-no-go"),
    path("portal-migration/admin/phase10m-go-no-go/", portal_phase10m_go_no_go, name="portal-phase10m-go-no-go"),
    path("portal-migration/admin/upcoming-discovery/", portal_legacy_upcoming_discovery, name="portal-upcoming-discovery"),
    path("portal-migration/admin/legacy-bookings/", portal_legacy_bookings, name="portal-legacy-bookings"),
    path("portal-migration/admin/legacy-bookings/<int:legacy_booking_id>/", portal_legacy_booking_detail, name="portal-legacy-booking-detail"),
    path("portal-migration/admin/migration-summary/", portal_migration_summary_dashboard, name="portal-migration-summary"),
    path("portal-migration/admin/legacy-blocks/", portal_legacy_booking_blocks, name="portal-legacy-booking-blocks"),
    path("portal-migration/admin/legacy-overview/", portal_legacy_migration_overview, name="portal-legacy-migration-overview"),
    path("portal-migration/admin/legacy-dry-run/", portal_legacy_migration_dry_run, name="portal-legacy-migration-dry-run"),
    path("portal-migration/admin/batches/<int:batch_id>/abort/", portal_legacy_batch_abort, name="portal-legacy-batch-abort"),
    ...
    path(
        ...
        lab_dashboard_calendar_colors,
        name="lab-dashboard-calendar-colors",
    ),
    ...
    path(
        "bookings/<int:booking_id>/results/attachments/<uuid:attachment_id>/",
        booking_result_attachment_download,
        name="booking-result-attachment-download",
    ),
    path(
        "bookings/<int:booking_id>/results/files/<int:file_id>/",
        booking_result_file_download,
    ...
    path("waitlist/<int:entry_id>/submit-sample/", submit_waitlist_sample, name="submit-waitlist-sample"),
