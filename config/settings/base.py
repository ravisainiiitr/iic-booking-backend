...
# Phase D — analysis / support mutations (OFF by default)
COPILOT_ANALYSIS_ACTIONS = env.bool("COPILOT_ANALYSIS_ACTIONS", default=False)
COPILOT_TICKET_CREATE = env.bool("COPILOT_TICKET_CREATE", default=False)
COPILOT_MULTI_INTENT = env.bool("COPILOT_MULTI_INTENT", default=True)
