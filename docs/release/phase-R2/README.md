# Phase R.2 — Zero-Touch / Device Provisioning

| Doc | Status |
|-----|--------|
| [R2.1 Device Provisioning Framework](R2.1-Device-Provisioning-Framework.md) | Implemented |
| [R2.2 DSA Zero-Touch Enrollment](R2.2-Department-Sync-Agent-Zero-Touch.md) | Implemented |
