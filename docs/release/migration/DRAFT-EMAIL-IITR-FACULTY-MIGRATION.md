# Draft email — IITR Faculty (migration)

**Audience:** IITR Faculty  
**Status:** Draft for review / send via migration notification tooling  
**Portal:** https://equip.iitr.ac.in  
**Booking window opens (as usual):** Wednesday, 30 September 2026, 9:00 PM  
**First week on new portal:** Week commencing Monday, 05 October 2026  

---

## Subject

New IIC Equipment Booking Portal — Booking opens Wed 30 Sep 2026, 9:00 PM | Action required for IITR Faculty

## Body (plain text)

Dear Faculty Colleague,

The Institute Instrumentation Centre (IIC), IIT Roorkee is launching the new IIC Equipment Booking Portal.
...
Please contact IIC for assistance if your wallet balance or transaction history does not appear after login.
