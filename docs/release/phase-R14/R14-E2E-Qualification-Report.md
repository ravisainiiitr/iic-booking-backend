...
| Migration `0187_equipment_auto_complete_and_data_selection` | PARTIAL | File present; `makemigrations --check` also reports unrelated pre-existing status-field drift (not generated) |
