...
class EquipmentDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'analysis_default_session_minutes',
            'analysis_extension_minutes',
            'analysis_raw_data_directory',
...
class EquipmentAdminWriteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'enable_remote_analysis', 'auto_complete_booking', 'remote_analysis_enabled_from_status',
            'analysis_workspace_retention_days', 'analysis_session_limit',
            'analysis_access_duration', 'analysis_default_session_minutes',
            'analysis_extension_minutes', 'analysis_raw_data_directory',
