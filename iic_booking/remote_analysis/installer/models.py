"""Agent installer release artifacts and catalog extensions for Phase 1 MVP."""
...
class AgentInstallerRelease(models.Model):
    """Published Remote Analysis Agent Setup EXE available from the portal."""
    ...
    class Meta:
        ...
        verbose_name = _("Agent installer release")
        verbose_name_plural = _("Agent installer releases")
