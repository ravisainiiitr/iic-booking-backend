...
urlpatterns = [
    ...
    # R6.1 — Software catalog + equipment mapping SPA (single source of truth; reuse catalog models)
    ...
    path("catalog/software/<uuid:catalog_id>/", catalog_admin_views.catalog_detail, name="catalog-software-detail"),
    path(
