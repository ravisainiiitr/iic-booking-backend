...
def sync_iit_roorkee_email_templates(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("communication", "0051_navy_ocean_email_branding"),
    ]

    operations = [
        migrations.RunPython(sync_iit_roorkee_email_templates, noop_reverse),
    ]
