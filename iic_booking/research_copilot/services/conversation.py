...
def bootstrap_payload(*, user) -> dict:
    ...
    return {
        ...
        "command_actions": [
            ...
            {"id": "compare_xrd", "label": "Compare XRD", "prompt": "Compare the available XRD machines."},
            {"id": "capability", "label": "Capability search", "prompt": "I need phase identification."},
            ...
            {"id": "dashboard", "label": "My day", "prompt": "What do I need to do today?"},
            ...
            {"id": "results", "label": "My results", "prompt": "Is my result ready?"},
            ...
            {"id": "profile", "label": "My profile", "prompt": "What department am I in?"},
            {"id": "support", "label": "Support", "prompt": "Create a support request."},
        ...
        "mutation_flags": {
            ...
            "analysis_actions": bool(getattr(settings, "COPILOT_ANALYSIS_ACTIONS", False)),
            "ticket_create": bool(getattr(settings, "COPILOT_TICKET_CREATE", False)),
